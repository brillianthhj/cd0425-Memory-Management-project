...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    ChatBot chatBot("../images/chatbot.png"); // deprecated function. okay to leave in
    _chatBot->SetChatLogicHandle(this); // TODO: pass handle to chatlogic to enable message-passing
